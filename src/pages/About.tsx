...
const About = () => {
  ...
  const aboutStructuredData = {
    ...
    "mainEntity": {
      "@type": "Organization",
      "name": "Snuspedia",
      "description": "Snuspedia est le leader de la vente de snus et sachets de nicotine au Burkina Faso. Notre mission est d'offrir une alternative sans fumée aux produits du tabac traditionnels.",
      ...
      "slogan": "Ne laissez pas les mauvaises habitudes gâcher les bons moments"
    }
  };
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-20 px-4">
        {/* Hero Section */}
        <section className="max-w-4xl mx-auto text-center py-16" aria-label="Introduction">
        ...
        {/* Story Section */}
        <section className="max-w-6xl mx-auto py-16" aria-label="Notre histoire">
        ...
        {/* Values Section */}
        <section className="max-w-6xl mx-auto py-16" aria-label="Nos valeurs">
        ...
        {/* Mission Section */}
        <section className="max-w-4xl mx-auto py-16 text-center" aria-label="Notre vision">
