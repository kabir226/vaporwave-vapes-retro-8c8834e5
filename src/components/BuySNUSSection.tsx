      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <p className="text-sm md:text-base text-muted-foreground mb-8">
            Be the first to know about new Snus releases, frequent discounts and giveaways for email subscribers only.
          </p>
        ...
        <div className="text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl mx-auto">
            <Button 
              variant="outline" 
              className="h-auto py-6 text-base font-semibold rounded-xl"
            >
              Nicotine Pouches
            </Button>
            ...
            <Button 
              variant="outline" 
              className="h-auto py-6 text-base font-semibold rounded-xl md:col-span-2"
            >
              Customer Support
            </Button>
          </div>
